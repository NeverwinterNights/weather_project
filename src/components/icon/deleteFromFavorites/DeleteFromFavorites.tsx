...
export const DeleteFromFavorites = React.memo(
  ({ onDeleteToFavoritesHandler }: ClosedPropsType) => {
    const DeleteFavoritesHandler = (): void => {
      onDeleteToFavoritesHandler();
    };

    const DeleteFavoritesKeyPressHandler = (e: KeyboardEvent<HTMLInputElement>): void => {
      if (e.key === 'Enter') {
        onDeleteToFavoritesHandler();
      }
    };
    return (
      <div
        ...
        onKeyPress={DeleteFavoritesKeyPressHandler}
